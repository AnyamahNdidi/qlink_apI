...
const RegisterDeveloper = async (req, res) => {
	try {
		...
		const mailOptions = {
			...
			href="https://shiny-blancmange-b361a8.netlify.app/api/user/dev/${CreateUser._id}/${getIkoken}"
			>link</a> </h1>
...
const RegisterClient = async (req, res) => {
	try {
		...
		const mailOptions = {
            ...
            <a href="https://shiny-blancmange-b361a8.netlify.app/api/user/client/reg/${CreateUser._id}/${getIkoken}">link</a>
            `,
		};
...

					{
						if (user.isDeveloper) {
							const mailOptions = {
								...
								html: `
				<h1>This is to verify your account please use click this <a 
				href="https://shiny-blancmange-b361a8.netlify.app/api/user/dev/${user._id}/${getIkoken}"
				>link</a> </h1>
				<h3>c\Copy this REFRENCE CODE <span style="color:green">${testToken}</span>  and finish up your reg. <br/></h3>
				`,
							};
							...
							const mailOptionse = {
								...
								html: `
				<h3>this is to verify your account, pease use the 
				<a href="https://shiny-blancmange-b361a8.netlify.app/api/user/client/reg/${user._id}/${getIkoken}">link</a>
